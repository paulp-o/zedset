...
<svelte:head>
	...
	<meta
		name="description"
		content="A powerful, user-friendly web-based GUI editor for Zed editor configuration files. Import, edit, and export your Zed settings with live validation, search, and intuitive interface."
	/>
	<meta
		name="keywords"
		content="Zed editor, settings editor, GUI, configuration, JSON editor, code editor settings, developer tools, Zed config"
	/>
	...
	>
		<div class="flex h-14 items-center px-4">
			...
			<div class="ml-auto flex items-center space-x-3">
				...
				{#if hasSharedConfig()}
					<div
						class="flex items-center space-x-2 rounded-md bg-blue-50 px-2.5 py-1 text-xs dark:bg-blue-950/50"
					>
						<div class="h-1.5 w-1.5 rounded-full bg-blue-500"></div>
						<span class="font-medium text-blue-700 dark:text-blue-300">Saved to URL</span>
					</div>
				{/if}
				...
				<a
					...
					class="inline-flex h-9 w-9 items-center justify-center rounded-md bg-background p-0 hover:bg-accent hover:text-accent-foreground"
